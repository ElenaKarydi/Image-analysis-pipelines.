...
The pipelines are implemented as **Fiji (ImageJ) macros** and are provided below.
...
* **File:** *(see corresponding macro)*
* **Description:** Fiji macro for measuring colocalizing foci.
...
Each macro can be opened and executed directly in Fiji. Please refer to the comments within each `.ijm` file for parameter explanations and usage instructions.
